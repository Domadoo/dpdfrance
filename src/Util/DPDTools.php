...
class DPDTools
{
    ...
    /**
     * Liste associative des codes pays ISO 3166-1 alpha-2 et alpha-3
     */
    const ISO3_TO_ISO2 = [
        'AUT' => 'AT',
        'ARE' => 'AE',
    ...
    /**
     * Get the time difference between two Datetimes in a script and the max_input_time value in the PHP configuration.
     * max_input_time (time during which the script accepts to parse input data such as POST and GET),
     * is used if it is different from -1, otherwise it is the max_execution_time value.
     * It is impossible to modify the max_input_time value.
     ...
     * @return bool
     */
    public static function getDiffDates($dateStart, $dateEnd): bool
    {
        $time = (int)($dateEnd->diff($dateStart))->format("%s");
        if ($time === ((int)ini_get('max_input_time') - 1)) {
            return true;
        }
